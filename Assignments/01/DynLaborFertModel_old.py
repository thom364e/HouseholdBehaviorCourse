...
class DynLaborFertModelClass_old(EconModelClass):
                ...
                for i_a,assets in enumerate(par.a_grid):
                    for i_k,capital in enumerate(par.k_grid):
                        ...
                        if t==par.T-1: # last period
                            ...
                            # call optimizer
                            hours_min = np.fmax( - (assets + self.exo_income(t) - self.childcare_cost(kids)) / self.wage_func(capital,t) + 1.0e-5 , 0.0) # minimum amount of hours that ensures positive consumption
    ...
    def cons_last(self,hours,assets,capital, kids):
        ...
        cons = assets + income + self.exo_income(par.T-1) - self.childcare_cost(kids)
        return cons
    ...
    def value_of_choice(self,cons,hours,assets,capital,kids,t):
        ...
        income = self.wage_func(capital,t) * hours + self.exo_income(t)
        ...
        for i in range(par.simN):
            ...
            for t in range(par.simT):
                ...
                if t<par.simT-1:
                    ...
                    income = self.wage_func(sim.k[i,t],t)*sim.h[i,t] + self.exo_income(t)
